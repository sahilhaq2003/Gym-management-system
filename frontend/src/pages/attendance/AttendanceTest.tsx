...
import { Fingerprint, User, CheckCircle2, AlertCircle, Loader2, LogOut } from 'lucide-react';
...
export function AttendanceTest() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[80vh] bg-background text-foreground animate-in fade-in zoom-in duration-500">
            <div className="w-full max-w-md space-y-8">
                <div className="text-center space-y-2">
                    <div className="inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-primary/10 text-primary shadow-glow">
                        <Fingerprint className="h-8 w-8" />
                    </div>
                    <h1 className="text-3xl font-bold tracking-tight">Kiosk Access</h1>
                    <p className="text-muted-foreground">Select action and verify identity</p>
                </div>
